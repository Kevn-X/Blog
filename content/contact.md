...
<section class="lg:pb-24">
  <div class="max-w-screen-md px-4 mx-auto">
      <p class="mb-8 font-light text-center text-gray-500 lg:mb-16 dark:text-gray-400 sm:text-xl">Got an EUC issue to discuss? Want to send some feedback or a leave us a comment? Let us know.</p>
      <form name="contact" action="https://formsubmit.co/734edb845b6abd85fcaccc929373f230" method="POST" class="space-y-8">
          <div class="my-4">
